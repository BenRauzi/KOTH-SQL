...
case 0: {//init
	...
	_lb = parseText "<br/>";
	_displayName = getText(configFile >> "cfgWeapons" >> _0xh >> "displayName");
	...
	_0lb = composeText [_mode_text,
		"	Weapon: ",_displayName,_lb,
		"Shots: ",str _0nf,_lb,
		"Hits: ", str _0ko,_lb,
		"Kills: ", str _kills,_lb,
		"Accuracy: ", str (_0ko/(_0nf max 1)),_lb];
	GET_CTRL(balca_stat_text_IDC) ctrlSetStructuredText _0lb;
};
case 1: {//reset
...
case 4: {//hit EH
	_01s = (_opt select 1);
	if ((_01s == (vehicle player))&&((_stat select 0) == currentWeapon(vehicle player))) then {
